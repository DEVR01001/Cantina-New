...
$result = Produto::getId($id_produto);
                ...
                <div class="conatiner_form_big">
                    <div class="left_form">
                        <div class="item_flex">
                            ...
                            <input name='nome' type="text" value='<?php echo $result->nome; ?>'>
                        </div>
                        <div class="item_flex">
                            <label for="">Categoria</label>
                            <select name='categoria' name="" id="" value='<?php echo $result->categoria; ?>'>
                        ...
                        <div class="item_flex">
                            ...
                            <input name='preco' type="text"  value='<?php echo $result->preco; ?>'>
                        </div>
                        <div class="item_flex">
                            <label for="">Status</label>
                            <select name="status" id=""  value='<?php echo $result->produtcStatus; ?>'>
                        ...
                        <div class="item_flex">
                            ...
                            <textarea name="descricao" id="" cols="30" rows="10"  value='<?php echo $result->descricao; ?>'>
                    ...
                    <div class="right_form">
                            <div class="item_flex">
                                ...
                                <input name='quantidade' type="number"  value='<?php echo $result->quantidade; ?>'>
                            </div>
                            <div class="item_flex">
                                <label for="">Foto</label>
                                <input  id="preview"  accept ="image/*" name='foto'  id="file"  type="file"  value='<?php echo $result->foto; ?>'>
                            </div>
                            <div class="conatiner_previe_img">
                                <img id='pre_visu' src="<?php echo $result->foto; ?>" alt="">
                                <p>Pré Visualização de imagem</p>
                            </div>
                            <div class="item_flex">
                                <label for="">Valores Nutricionais</label>
                                <textarea name="valor_nutri" id="" cols="30" rows="10"  value='<?php echo $result->valor_nutricional; ?>'>
                                    <?php echo $result->valor_nutricional; ?>
                                </textarea>
                            </div>
